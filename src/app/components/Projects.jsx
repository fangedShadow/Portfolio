        ...
        <div className={`text-greyWhite ${playfairDisplay.className} sect lg:w-5/6 w-full mt-10 md:mt-0 mb-20`} id='projects'>
            <div className='flex flex-col'>
                ...
                <div className='flex justify-around p-2 gap-4 flex-col ml-4'>
                    <div>
                        <a href="https://shelves-o7hn82av3-ayman-haques-projects.vercel.app" target="_blank" rel="noopener noreferrer">
                            <div className='project_tile flex justify-center h-full sm:hover:rounded-lg sm:hover:bg-hoverBlack sm:hover:cursor-pointer sm:hover:animate-enlarge-text'>
                                <div className='flex flex-col pb-2 pl-1 items-center hover:bg-hoverBlack hover:cursor-pointer hover:rounded-lg sm:hover:none sm:hover:animate-none hover:animate-enlarge-text'>
                                    ...
                                    <div className='img flex items-start pt-4'>
                                        <Image
                                            src={lds}
                                            className='rounded-md p-1 xs:w-[200px]'
                                            width={300}
                                            height={200}
                                            alt='Shelves'
                                        />
                                ...
                                <div className='w-9/12 hidden sm:flex sm:items-start sm:flex-col pl-4 pt-4 gap-1 hovText'>
                                    ...
                                    <p className='xl:text-base text-sm text-darkGreyWhite text-justify pr-2'>
                                        Integrated Node.js, Next.js, MongoDB, and others, with features like personalized
                                        recommendations and seamless book delivery.

                                        <span className='hidden lg:inline ml-1'>
                                            Our main objective is to offer a convenient platform for accessing physical library books,
                                            bypassing the need to visit libraries in person and serving as a learning opportunity for us
                                            to explore new technologies hands-on.
                                        </span>
                                    </p>
                                    <div className='flex-row flex-wrap justify-evenly gap-3 hidden md:flex'>
                                        <div className='bg-mainRed rounded-xl py-0.5 px-2 text-center'> Next.JS </div>
                                        ...
                                        <div className='bg-mainRed rounded-xl py-0.5 px-2 text-center'> Tailwind </div>
                                        <div className='bg-mainRed rounded-xl py-0.5 px-2 text-center'> Clerk </div>
                                    </div>
                                </div>
                            </div>
                        </a>
